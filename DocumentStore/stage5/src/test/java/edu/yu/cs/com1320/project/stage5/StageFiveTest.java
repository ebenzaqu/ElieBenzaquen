...
public class StageFiveTest {

    BTreeImpl<String, String> store = new BTreeImpl<String, String>();
    ...
    //     BTreeImpl<Integer, String> table = new BTreeImpl<Integer, String>(new File(System.getProperty("user.dir")));
    //     for(int i = 0; i <= 23; i++) {
    //         table.put(i, "entry " + i);
    //     }
    ...
    public void InsertDocumentsIntoHeapWithCountLimit() throws URISyntaxException {
        ...
        URI uri2 = new URI("/Effa");
        URI uri3 = new URI("/kd");
        String path = "C:/Users/elieb/OneDrive/Desktop/TEMPFOLDER";
        File file = new File(path);
        DocumentStoreImpl document = new DocumentStoreImpl(file);
        document.setMaxDocumentCount(0);
		document.putDocument(targetStream, uri, DocumentFormat.TXT);
        document.putDocument(targetStream2, uri2, DocumentFormat.TXT);
        document.putDocument(targetStream3, uri3, DocumentFormat.TXT);
        List<String> list = new ArrayList<>();
        File filePath = new File("C:/Users/elieb/OneDrive/Desktop/TEMPFOLDER/Effa.json");
        File filePath2 = new File("C:/Users/elieb/OneDrive/Desktop/TEMPFOLDER/www.yu.edu/documents/doc1.json");
        assertTrue("hi", filePath.exists());
        assertTrue("hi2", filePath2.exists());
        list.add(initialString2);
        list.add(initialString);
        list.add(initialString3);
        document.setMaxDocumentCount(4);
        assertEquals("should give back an empty list",list, document.search("is"));
        assertFalse("hi", filePath.exists());
        assertFalse("hi2", filePath2.exists());
    }
    ...
    public void DeleteAllThenUndoWithCountLimit() throws URISyntaxException {
        ...
        document.putDocument(targetStream2, uri2, DocumentFormat.TXT);
        document.putDocument(targetStream3, uri3, DocumentFormat.TXT);
        File newFile = new File("C:\\Users\\elieb\\MyGit\\BenzaquenElie\\DataStructures\\project\\stage5\\kkd.json");
        assertFalse("hi2", newFile.exists());
        document.deleteAll("this");
        document.setMaxDocumentCount(1);
        document.undo();
        assertTrue("hi", newFile.exists());
        List<String> list = new ArrayList<>();
        list.add(initialString);
        list.add(initialString2);
        list.add(initialString3);
        document.setMaxDocumentCount(3);
        // document.getDocumentAsTxt(uri);
