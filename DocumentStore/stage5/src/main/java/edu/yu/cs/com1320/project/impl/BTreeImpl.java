...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key, Value> {
    ...
    private static final class Node {
        ...
        //all these methods are only for the linked list
        ...
        if (entry != null) {
            ...
            if (entry.val == null){
                ...
                try{
                    ...
                    //there was nothing there and was deleted already
                    if (val == null){
                        return null;
                    }

                    //a value was found. put it back into the Btree
                    this.put(key, val);
        ...
        if (alreadyThere != null) {
            ...
            if(alreadyThere.val == null){
                ...
                try{
                    ...
                    try{
                        Value diskVal = pm.deserialize(key);
